<section class="section section-white privacy">
    <div class="container">
        <h2 class="section-title">Polityka Prywatności Al-Land</h2>
	...
	<ul style="list-style: lower-alpha;"><li>Prowadzenie systemu komentarzy</li><li>Obsługa zapytań przez formularz</li><li>Przygotowanie, pakowanie, wysyłka towarów</li><li>Realizacja zamówionych usług</li><li>Prezentacja oferty lub informacji</li>
	</ul>
	...
	<ol>
	<li>Serwis jest hostowany (technicznie utrzymywany) na serwerach operatora: home.pl</li>
	...
	<ol><li>W niektórych sytuacjach Administrator ma prawo przekazywać Twoje dane osobowe innym odbiorcom, jeśli będzie to niezbędne do wykonania zawartej z Tobą umowy lub do zrealizowania obowiązków ciążących na Administratorze. Dotyczy to takich grup odbiorców:<ul style="list-style: lower-alpha;"><li>kurierzy</li><li>banki</li><li>operatorzy płatności</li><li>operatorzy systemu komentarzy</li></ul></li>
